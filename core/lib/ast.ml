(** Abstract Syntax Tree for AI Language Personality DSL 
    
    This module defines the core data structures and utilities for parsing,
    manipulating, and working with AI personality definitions. The AST supports
    rich personality modeling including:
    
    - Dynamic traits with contextual modifiers
    - Knowledge domains with expertise levels  
    - Behavioral rules for conversation guidance
    - Evolution specifications for personality growth through interactions
    
    Designed specifically for AI language models and conversational agents.
*)
